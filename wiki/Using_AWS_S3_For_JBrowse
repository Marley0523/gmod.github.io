...
- <span id="pt-login"><a
  href="http://gmod.org/mediawiki/index.php?title=Special:UserLogin&amp;returnto=Using+AWS+S3+For+JBrowse"
  accesskey="o"
...
- <span id="ca-view">[Read](Using_AWS_S3_For_JBrowse)</span>
- <span id="ca-viewsource"><a
  href="http://gmod.org/mediawiki/index.php?title=Using_AWS_S3_For_JBrowse&amp;action=edit"
  accesskey="e" title="This page is protected.
  You can view its source [e]">View source</a></span>
- <span id="ca-history"><a
  href="http://gmod.org/mediawiki/index.php?title=Using_AWS_S3_For_JBrowse&amp;action=history"
