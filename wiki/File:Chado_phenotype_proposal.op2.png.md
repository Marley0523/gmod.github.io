...
- <span id="pt-anontalk"><a href="User_talk:76.82.147.53" class="new" accesskey="n"
  ...
  address</a></span>
- <span id="pt-login"><a
  href="http://gmod.org/mediawiki/index.php?title=Special:UserLogin&amp;returnto=File%3AChado+phenotype+proposal.op2.png"
  accesskey="o"
...
- <span id="ca-view">[Read](File:Chado_phenotype_proposal.op2.png)</span>
- <span id="ca-viewsource"><a
  href="http://gmod.org/mediawiki/index.php?title=File:Chado_phenotype_proposal.op2.png&amp;action=edit"
  accesskey="e" title="This page is protected.
  You can view its source [e]">View source</a></span>
- <span id="ca-history"><a
  href="http://gmod.org/mediawiki/index.php?title=File:Chado_phenotype_proposal.op2.png&amp;action=history"
