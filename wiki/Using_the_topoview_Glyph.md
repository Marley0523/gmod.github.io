...
- <span id="pt-login"><a
  href="http://gmod.org/mediawiki/index.php?title=Special:UserLogin&amp;returnto=Using+the+topoview+Glyph"
  accesskey="o"
...
- <span id="ca-view">[Read](Using_the_topoview_Glyph)</span>
- <span id="ca-form_edit">[View
  form](http://gmod.org/mediawiki/index.php?title=Using_the_topoview_Glyph&action=formedit)</span>
- <span id="ca-viewsource"><a
  href="http://gmod.org/mediawiki/index.php?title=Using_the_topoview_Glyph&amp;action=edit"
  accesskey="e" title="This page is protected.
  You can view its source [e]">View source</a></span>
- <span id="ca-history"><a
  href="http://gmod.org/mediawiki/index.php?title=Using_the_topoview_Glyph&amp;action=history"
