...
- <span id="pt-login"><a
  href="http://gmod.org/mediawiki/index.php?title=Special:UserLogin&amp;returnto=MOD+User+Interfaces%3A+outline+of+topics"
  accesskey="o"
...
- <span id="ca-view">[Read](MOD_User_Interfaces:_outline_of_topics)</span>
- <span id="ca-viewsource"><a
  href="http://gmod.org/mediawiki/index.php?title=MOD_User_Interfaces:_outline_of_topics&amp;action=edit"
  accesskey="e" title="This page is protected.
  You can view its source [e]">View source</a></span>
- <span id="ca-history"><a
  href="http://gmod.org/mediawiki/index.php?title=MOD_User_Interfaces:_outline_of_topics&amp;action=history"
