...
- <span id="pt-login"><a
  href="http://gmod.org/mediawiki/index.php?title=Special:UserLogin&amp;returnto=GBrowse+UCSC+Plugin+Install+HOWTO"
  accesskey="o"
...
- <span id="ca-view">[Read](GBrowse_UCSC_Plugin_Install_HOWTO)</span>
- <span id="ca-viewsource"><a
  href="http://gmod.org/mediawiki/index.php?title=GBrowse_UCSC_Plugin_Install_HOWTO&amp;action=edit"
  accesskey="e" title="This page is protected.
  You can view its source [e]">View source</a></span>
- <span id="ca-history"><a
  href="http://gmod.org/mediawiki/index.php?title=GBrowse_UCSC_Plugin_Install_HOWTO&amp;action=history"
