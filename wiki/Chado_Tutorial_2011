...
information about all gene features in our database: \<sql\> SELECT
gene.feature_id, gene.uniquename, gene.name

      FROM feature gene
           JOIN cvterm c ON gene.type_id = c.cvterm_id
     WHERE c.name = 'gene';</sql>
...
### <span id="Reload_a_new_copy_of_the_DB_with_ontologies_in_it" class="mw-headline">Reload a new copy of the DB with ontologies in it</span>
...
The [BioPerl](BioPerl "BioPerl") code that parses the [GFF](GFF "GFF")
has a few problems with standard GFF3, so we'll fix the GFF file from
the [MAKER](MAKER.1 "MAKER") session (`scf1117875582023.gff`) to make
the loader happy. These two lines:
...
Oops. Forgot to edit the [GFF](GFF "GFF") file
...
- <a href="http://gmod.org/Chado" class="external text"
  rel="nofollow">Chado</a>
- <a href="http://gmod.org/GMOD_Mailing_List" class="external text"
  rel="nofollow">GMOD-Schema Mailing list</a>
- *<a href="http://gmod.org/wiki/index.php/Image:A_Chado_Case_Study.pdf"
  class="external text" rel="nofollow">A Chado case study: an
  ontology-based modular schema for representing genome-associated
...
2011](Special:Browse/Chado-20Tutorial-202011 "Special:Browse/Chado-20Tutorial-202011")</span>"</span><span class="smwrdflink"><span class="rdflink">[RDF
...
- <span id="pt-login"><a
  href="http://gmod.org/mediawiki/index.php?title=Special:UserLogin&amp;returnto=Chado+Tutorial+2011"
  accesskey="o"
...
- <span id="ca-nstab-main"><a href="Chado_Tutorial_2011" accesskey="c"
...
- <span id="ca-view">[Read](Chado_Tutorial_2011)</span>
- <span id="ca-viewsource"><a
  href="http://gmod.org/mediawiki/index.php?title=Chado_Tutorial_2011&amp;action=edit"
  accesskey="e" title="This page is protected.
  You can view its source [e]">View source</a></span>
- <span id="ca-history"><a
  href="http://gmod.org/mediawiki/index.php?title=Chado_Tutorial_2011&amp;action=history"
...
- <span id="t-whatlinkshere"><a href="Special:WhatLinksHere/Chado_Tutorial_2011" accesskey="j"
  title="A list of all wiki pages that link here [j]">What links here</a></span>
- <span id="t-recentchangeslinked"><a href="Special:RecentChangesLinked/Chado_Tutorial_2011" accesskey="k"
  title="Recent changes in pages linked from this page [k]">Related
  changes</a></span>
- <span id="t-specialpages"><a href="Special:SpecialPages" accesskey="q"
  title="A list of all special pages [q]">Special pages</a></span>
- <span id="t-print"><a
  href="http://gmod.org/mediawiki/index.php?title=Chado_Tutorial_2011&amp;printable=yes"
  rel="alternate" accesskey="p"
  title="Printable version of this page [p]">Printable version</a></span>
- <span id="t-permalink">[Permanent
  link](http://gmod.org/mediawiki/index.php?title=Chado_Tutorial_2011&oldid=24433 "Permanent link to this revision of the page")</span>
- <span id="t-info">[Page
  information](http://gmod.org/mediawiki/index.php?title=Chado_Tutorial_2011&action=info)</span>
- <span id="t-smwbrowselink"><a href="Special:Browse/Chado_Tutorial_2011" rel="smw-browse">Browse
  properties</a></span>
- <span id="t-pdf">[Print as
  PDF](http://gmod.org/mediawiki/index.php?title=Special:PdfPrint&page=Chado_Tutorial_2011)</span>
