...
- <span id="pt-login"><a
  href="http://gmod.org/mediawiki/index.php?title=Special:UserLogin&amp;returnto=Extending+Embedding+and+Customizing+JBrowse"
  accesskey="o"
...
- <span id="ca-view">[Read](Extending_Embedding_and_Customizing_JBrowse)</span>
- <span id="ca-viewsource"><a
  href="http://gmod.org/mediawiki/index.php?title=Extending_Embedding_and_Customizing_JBrowse&amp;action=edit"
  accesskey="e" title="This page is protected.
  You can view its source [e]">View source</a></span>
- <span id="ca-history"><a
  href="http://gmod.org/mediawiki/index.php?title=Extending_Embedding_and_Customizing_JBrowse&amp;action=history"
