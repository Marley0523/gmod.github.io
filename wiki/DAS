...
- <span id="pt-login"><a
  href="http://gmod.org/mediawiki/index.php?title=Special:UserLogin&amp;returnto=Distributed+Annotation+System"
  accesskey="o"
...
- <span id="ca-view">[Read](Distributed_Annotation_System)</span>
- <span id="ca-viewsource"><a
  href="http://gmod.org/mediawiki/index.php?title=Distributed_Annotation_System&amp;action=edit"
  accesskey="e" title="This page is protected.
  You can view its source [e]">View source</a></span>
- <span id="ca-history"><a
  href="http://gmod.org/mediawiki/index.php?title=Distributed_Annotation_System&amp;action=history"
...
- <span id="t-whatlinkshere"><a href="Special:WhatLinksHere/Distributed_Annotation_System"
  accesskey="j" title="A list of all wiki pages that link here [j]">What
  links here</a></span>
- <span id="t-recentchangeslinked"><a href="Special:RecentChangesLinked/Distributed_Annotation_System"
  accesskey="k"
...
- <span id="t-print"><a
  href="http://gmod.org/mediawiki/index.php?title=Distributed_Annotation_System&amp;printable=yes"
  rel="alternate" accesskey="p"
  title="Printable version of this page [p]">Printable version</a></span>
- <span id="t-permalink">[Permanent
  link](http://gmod.org/mediawiki/index.php?title=Distributed_Annotation_System&oldid=21745 "Permanent link to this revision of the page")</span>
- <span id="t-info">[Page
  information](http://gmod.org/mediawiki/index.php?title=Distributed_Annotation_System&action=info)</span>
- <span id="t-smwbrowselink"><a href="Special:Browse/Distributed_Annotation_System"
  rel="smw-browse">Browse properties</a></span>
- <span id="t-pdf">[Print as
  PDF](http://gmod.org/mediawiki/index.php?title=Special:PdfPrint&page=Distributed_Annotation_System)</span>
