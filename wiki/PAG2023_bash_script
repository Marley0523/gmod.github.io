...
- <span id="pt-login"><a
  href="http://gmod.org/mediawiki/index.php?title=Special:UserLogin&amp;returnto=PAG2023+bash+script"
  accesskey="o"
...
- <span id="ca-view">[Read](PAG2023_bash_script)</span>
- <span id="ca-viewsource"><a
  href="http://gmod.org/mediawiki/index.php?title=PAG2023_bash_script&amp;action=edit"
  accesskey="e" title="This page is protected.
  You can view its source [e]">View source</a></span>
- <span id="ca-history"><a
  href="http://gmod.org/mediawiki/index.php?title=PAG2023_bash_script&amp;action=history"
