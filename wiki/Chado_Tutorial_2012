...
class="external text" rel="nofollow">Chado workshop (whose pdf seems to
be lost in the mists of time)</a>.
...
Every horizontal line becomes a record in the feature table, every
vertical line becomes a record in the feature_relationship table, and
every red line becomes an entry in the analysisfeature table.
...
difficult to install by CPAN when using `sudo cpan` but is easy to
install "by hand" or using `cpan`.
...
Trying again:
     ...
     Use values in '/home/ubuntu/schema/chado/build.conf'? [Y] n
...
To make a db dump, do this:
     ...
     pg_dump chado_test | bzip2 -c --best > db_w_ontologies.bz2
...
We need to tell the loader that it is in fact analysis results:
     ...
     gmod_bulk_load_gff3.pl --analysis -g new.gff
...
already have them). One (at least) more time:
     ...
     gmod_bulk_load_gff3.pl --analysis -g scf1117875582023.gff --noexon
...
Retrieved from
"<http://gmod.org/mediawiki/index.php?title=Chado_Tutorial_2012&oldid=27707>"
...
- <span id="pt-login"><a
  href="http://gmod.org/mediawiki/index.php?title=Special:UserLogin&amp;returnto=Chado+Tutorial+2012"
  accesskey="o"
...
- <span id="ca-nstab-main"><a href="Chado_Tutorial_2012" accesskey="c"
  title="View the content page [c]">Page</a></span>
- <span id="ca-talk"><a
  href="http://gmod.org/mediawiki/index.php?title=Talk:Chado_Tutorial_2012&amp;action=edit&amp;redlink=1"
  accesskey="t"
...
- <span id="ca-view">[Read](Chado_Tutorial_2012)</span>
- <span id="ca-viewsource"><a
  href="http://gmod.org/mediawiki/index.php?title=Chado_Tutorial_2012&amp;action=edit"
  accesskey="e" title="This page is protected.
  You can view its source [e]">View source</a></span>
- <span id="ca-history"><a
  href="http://gmod.org/mediawiki/index.php?title=Chado_Tutorial_2012&amp;action=history"
...
- <span id="t-whatlinkshere"><a href="Special:WhatLinksHere/Chado_Tutorial_2012" accesskey="j"
  title="A list of all wiki pages that link here [j]">What links here</a></span>
- <span id="t-recentchangeslinked"><a href="Special:RecentChangesLinked/Chado_Tutorial_2012" accesskey="k"
  title="Recent changes in pages linked from this page [k]">Related
  changes</a></span>
- <span id="t-specialpages"><a href="Special:SpecialPages" accesskey="q"
  title="A list of all special pages [q]">Special pages</a></span>
- <span id="t-print"><a
  href="http://gmod.org/mediawiki/index.php?title=Chado_Tutorial_2012&amp;printable=yes"
  rel="alternate" accesskey="p"
  title="Printable version of this page [p]">Printable version</a></span>
- <span id="t-permalink">[Permanent
  link](http://gmod.org/mediawiki/index.php?title=Chado_Tutorial_2012&oldid=27707 "Permanent link to this revision of the page")</span>
- <span id="t-info">[Page
  information](http://gmod.org/mediawiki/index.php?title=Chado_Tutorial_2012&action=info)</span>
- <span id="t-smwbrowselink"><a href="Special:Browse/Chado_Tutorial_2012" rel="smw-browse">Browse
  properties</a></span>
- <span id="t-pdf">[Print as
  PDF](http://gmod.org/mediawiki/index.php?title=Special:PdfPrint&page=Chado_Tutorial_2012)</span>
